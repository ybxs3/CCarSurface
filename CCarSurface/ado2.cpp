...
BOOL CADODatabase::Open(LPCTSTR lpstrConnection, LPCTSTR lpstrUserID, LPCTSTR lpstrPassword)
{
	...
	if(_tccmp(lpstrConnection, _T("")) != 0)
...
void CADODatabase::dump_com_error(_com_error &e)
{
	...
	CString str1;
	str1=(LPCSTR)bstrSource;
	CString str2;
	str2=(LPCSTR)bstrDescription;
	ErrorStr+=str1+_T("\n\tDescription =")+str2+_T("\n");
	//m_strErrorDescription = (LPCSTR)bstrDescription ;
	//m_strLastError = _T("Connection String = " + GetConnectionString() + '\n' + ErrorStr);
	m_dwLastError = e.Error(); 
...
BOOL CADORecordset::GetFieldValue(LPCTSTR lpFieldName, ULONGLONG& ulValue)
{
	ULONGLONG nResult = 0;
	_variant_t vtFld;
	...
	try
	{
		...
		{
		case VT_R4:
			nResult = vtFld.fltVal;
			break;
		case VT_R8:
			nResult = vtFld.dblVal;
			break;
		case VT_I2:
		case VT_UI1:
			nResult = vtFld.iVal;
...
BOOL CADORecordset::GetFieldInfo(FieldPtr pField, CADOFieldInfo* fldInfo)
{
	...
	_tccpy(fldInfo->m_strName, (LPCTSTR)pField->GetName());
